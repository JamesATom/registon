// create-survey.entity.ts
import { ApiProperty } from '@nestjs/swagger';

export class CreateSurveyPresignedUploadEntity {
    @ApiProperty({
    ...
    @ApiProperty({
        ...
        example: 'https://registon-edu.fra1.digitaloceanspaces.com/survey/4513c94a-93a3-4429-8edd-b1d34c487044-survey-image.jpg',
    })
    publicUrl: string;
}
