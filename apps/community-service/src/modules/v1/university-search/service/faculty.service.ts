...
export class FacultyService {
    ...
    async getOne(id: string): Promise<any> {
        ...
        if (!faculty) {
            return this.formatResponse(HttpStatus.NOT_FOUND, `Faculty with ID ${id} not found`, null);
        }
        return this.formatResponse(HttpStatus.OK, `Faculty with ID ${id} retrieved successfully`, faculty);
    }
    ...
    async update(id: string, updateFacultyDto: UpdateFacultyDto): Promise<any> {
        ...
        return this.formatResponse(HttpStatus.OK, `Faculty with ID ${id} updated successfully`, updatedFaculty);
    }
    ...
    async delete(id: string): Promise<any> {
        ...
        return this.formatResponse(HttpStatus.OK, `Faculty with ID ${id} deleted successfully`, null);
    }
}
